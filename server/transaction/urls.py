...
urlpatterns = [
    path('list/<uuid:uuid>',ListTransactions.as_view(), name='List Transactions from Group'),
    ...
    path('list/group/<uuid:uuid>', ListGroups.as_view(), name="List Transaction Groups"),
